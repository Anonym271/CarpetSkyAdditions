...
public abstract class AbstractSkyBlockChunkGenerator extends NoiseChunkGenerator {
  protected final Registry<DoublePerlinNoiseSampler.NoiseParameters> noiseRegistry;
  protected final Supplier<List<PlacedFeatureIndexer.IndexedFeatures>> indexedFeaturesListSupplier;
/*
  public static final Codec<AbstractSkyBlockChunkGenerator> CODEC =
        ...
        NoiseChunkGenerator.createStructureSetRegistryGetter(instance).and(
            instance
              .group(
                ...
                (ChunkGeneratorSettings.REGISTRY_CODEC.fieldOf("settings")).forGetter(AbstractSkyBlockChunkGenerator::getSettings)))
          .apply(instance, instance.stable(AbstractSkyBlockChunkGenerator::new)));
*/

  public AbstractSkyBlockChunkGenerator(Registry<StructureSet> structureRegistry, Registry<DoublePerlinNoiseSampler.NoiseParameters> noiseRegistry,
  ...
  public abstract void prepareSpawn(ServerWorld world, BlockPos worldSpawn, boolean bonusChest);
